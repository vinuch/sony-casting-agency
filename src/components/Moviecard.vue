<template>
  <div v-if="!editing" class="bg-gray-100 rounded-md mb-8 mx-2 sm:w-3/12 py-10 px-6 cursor-pointer transition duration-500 ease-in-out transform sm:hover:-translate-y-4 sm:hover:shadow-xl sm:hover:scale-105">
